...
Verify the working directory is a Git repository containing `PRD.md`. If it is not, read `~/.wtfdoibuild/projects.md`, list known projects, and print the exact `cd` command for the relevant one. Do not build outside a matching project.
